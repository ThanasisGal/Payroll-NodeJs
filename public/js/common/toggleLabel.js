...
function toggleCheckboxState(checkboxId) {
    ...
    switch (checkboxId) {
        case 'oikodomika_erga':
            setFieldsDisabled(
                ['ypergolabia', 'amoe', 'eidos_ergoy', 'username_ergoy', 'password_ergoy'],
                !isChecked
            );
            if (!isChecked) {
                ...
                setFieldsDisabled(
                    [
                        ...
                        'polh_ergolaboy',
                        'ame_ergolaboy',
                        'pararthma_efka_ergolaboy',
                        'username_ypergol_ergoy',
                        'password_ypergol_ergoy'
                    ],
                    true
                );
            }
