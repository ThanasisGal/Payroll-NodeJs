document.addEventListener("DOMContentLoaded", function () {
    var checkboxes = [
        "energos", "fylo", "apasxolhsh_gia_proth_fora", "karta_ergasias", "syggeneia", "topos_ergasias", "afora_dokimastikh_periodo", "plhrhs_apasxolhsh", "dieythethsh_xronoy_ergasias", "dialleima_entos_ektos_orarioy", "typos_orarioy", "synexes_diakekomeno", "pshfiakh_organosh", "asfalish_me_tekmarta", "epoxikos", "xarakthrismos_ergazomenon", "meiosh_eisforon_ergazomenon", "epidothsh_eisforon_ergodoth", "mhteres", "diathesimothta", "palios_neos", "amoibetai_me_sse", "systatiko_shmeioma", "antikatastash_ergazomenoy", "epidoma_anergias", "adeia_diamonhs_me_amesh_prosbash_gia_ergasia", 
...
function toggleCheckboxState(checkboxId, isChecked) {
    ...
    switch (checkboxId) {
        ...
        case "synexes_diakekomeno":
            ...
            break;
        case "topos_ergasias":
            label.textContent = isChecked ? "ΠΑΡΑΡΤΗΜΑ ΕΡΓΟΔΟΤΗ" : "ΑΛΛΟ";
            break;
