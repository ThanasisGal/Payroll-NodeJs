document.addEventListener("DOMContentLoaded", function () {
    ...
    checkboxes.forEach(function(checkboxId) {
        ...
        if (checkbox) {
            checkbox.addEventListener("change", function () {
                ...
                if (checkboxId === "adeia_diamonhs_me_amesh_prosbash_gia_ergasia" || 
    ...
    // =========================================================================
    const adeiaAmeshCheckbox = document.getElementById('adeia_diamonhs_me_amesh_prosbash_gia_ergasia');
    const adeiaXorisCheckbox = document.getElementById('adeia_diamonhs_xwris_amesh_prosbash_gia_ergasia');
    ...
    if (customButtonAllodapoi) {
        ...
        function checkAndUpdateAllodapoiButton() {
            ...
            const atLeastOneChecked = (adeiaAmeshCheckbox && adeiaAmeshCheckbox.checked) || 
