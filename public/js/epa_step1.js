...
(function () {
    ...
    const byIdOrName = (idOrName) =>
        document.getElementById(idOrName) || document.querySelector(`input[name="${idOrName}"]`);
    ...
    const setTmpBackup = (val) => {
        const tmp = byIdOrName('tmp_kpk_efka_stathera') || byIdOrName('tmp_kpk_efka'); // εναλλακτικό id/name αν χρησιμοποιείται
