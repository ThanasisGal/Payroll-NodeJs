document.addEventListener("DOMContentLoaded", () => {
    ...
    async function handleFormSubmit(event) {
        ...
        try {
            ...
            const stoixeiaSymbaseonId = document.getElementById("stoixeiaSymbaseonId").value;

            const response = await fetch("/api/stoixeiaSymbaseon/update/" + stoixeiaSymbaseonId, {
                method: "POST",
                headers: {
            ...
            if (response.status === 204) {
                ...
                }).then(() => window.location.href = "/symbaseis/stoixeiaSymbaseon");
                return;
            }
            ...
            if (ct.includes("application/json")) {
                ...
                await Swal.fire({
                    ...
                    window.location.href = data.redirectUrl || "/symbaseis/stoixeiaSymbaseon";
                });
                return;
            }
