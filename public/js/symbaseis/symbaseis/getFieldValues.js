document.addEventListener("DOMContentLoaded", () => {
    ...
    async function handleFormSubmit(event) {
        ...
        try {
            ...
            const response = await fetch("/symbaseis/symbaseis/add", {
                method: "POST",
                headers: {
            ...
            if (response.status === 204) {
                ...
                }).then(() => window.location.href = "/symbaseis/symbaseis");
                return;
            }
            ...
            if (ct.includes("application/json")) {
                ...
                await Swal.fire({
                    ...
                    window.location.href = data.redirectUrl || "/symbaseis/symbaseis";
                });
                return;
            }
