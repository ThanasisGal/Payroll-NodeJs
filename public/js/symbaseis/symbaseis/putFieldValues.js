...
//     try {
//       const symbaseisId = document.getElementById("symbaseisId").value;
      
//       await Promise.all(filePromises);
//       const response = await fetch("/api/symbaseis/update/" + symbaseisId, {
//         method: "POST",
//         headers: {
...
//           html: `
//             <ul>
//               <li class="fw600">των Συμβάσεων</li>
//             </ul>
//           `,
//           timer: 3000,
    ...
    async function handleFormSubmit(event) {
        ...
        try {
            ...
            if (response.status === 204) {
                ...
                }).then(() => window.location.href = `/symbaseis/symbaseis/edit/${symbaseisId}`);
                return;
            }
            ...
            if (ct.includes("application/json")) {
                ...
                }).then(() => window.location.href = data.redirectUrl || `/symbaseis/symbaseis/edit/${symbaseisId}`);
                return;
            }
