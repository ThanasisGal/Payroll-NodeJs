document.addEventListener("DOMContentLoaded", () => {
    ...
    async function handleFormSubmit(event) {
        ...
        try {
            ...
            const eidikothtesId = document.getElementById("eidikothtesId").value;

            const response = await fetch("/api/eidikothtesSymbaseon/update/" + eidikothtesId, {
                method: "POST",
                headers: {
            ...
            if (response.status === 204) {
                ...
                }).then(() => window.location.href = "/symbaseis/eidikothtes");
                return;
            }
            ...
            if (ct.includes("application/json")) {
                ...
                await Swal.fire({
                    ...
                    window.location.href = data.redirectUrl || "/symbaseis/eidikothtes";
                });
                return;
            }
