    ...
    const tom = new TomSelect(el, {
                ...
                try {
                    ...
                    this.on('change', (value) => {
                        ...
                        Object.keys(mappings).forEach(sourceField => {
                            ...
                            } else if (sourceField.includes('isxyei') || sourceField.includes('date') || sourceField.includes('hmeromhnia')) {
        ...
        onDropdownOpen () {
            ...
            if (! this._infiniteBound) {
                const content = this.dropdown ?  this.dropdown.querySelector('.ts-dropdown-content') : null;
                if (content) {
