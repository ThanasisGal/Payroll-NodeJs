  ...
  rows.forEach(function (row) {
    row.addEventListener("click", function () {
      if (this.classList.contains("selected-row")) {
        ...
        if (selectedRowId) {
          document.getElementById("edit-btn").href =
            "/companies/ypokatasthmata/edit/" + selectedRowId;
          document
            ...
            .addEventListener("click", async function (event) {
              ...
              var deleteUrl = "/companies/ypokatasthmata/delete/" + selectedRowId;

              const result = await Swal.fire({
                title: "Είστε σίγουρος / η;",
                text: "ΠΡΟΣΟΧΗ!!! Δεν θα μπορείτε να αναιρέσετε αυτή την ενέργεια! Με την διαγραφή του υποκαταστήματος θα διαγραφούν (απ΄ όλα τα αρχεία) οι εγγραφές, που αφορούν το συγκεκριμένο υποκατάστημα.",
                icon: "error",
              ...
              if (result.isConfirmed) {
                try {
                  ...
                  Swal.fire({
                    icon: "success",
                    title: "Επιτυχής Διαγραφή του Υποκαταστήματος",
                    timer: 3000,
                  ...
                  Swal.fire({
                    icon: "error",
                    title: "Σφάλμα κατά τη Διαγραφή του Υποκαταστήματος",
                    ...
                    willClose: () => {
                      window.location.href = "/companies/ypokatasthmata"; // Ανακατεύθυνση μετά το κλείσιμο του SweetAlert
                    },
                  });
                }
              }
