document.addEventListener('DOMContentLoaded', () => {
    ...
    // ---- Αν έχεις select τράπεζας, revalidate σε αλλαγή ----
    if (bankSelect) {
    ...
    // ---- Αν έχεις hidden που αλλάζει από JS, revalidate όταν αλλάζει η value ----
    // (θα πρέπει όπου το ενημερώνεις να κάνεις: bankHidden.dispatchEvent(new Event('change')))
    if (bankHidden) {
