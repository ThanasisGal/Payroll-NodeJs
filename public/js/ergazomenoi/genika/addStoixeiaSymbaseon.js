  ...
  for (let i = 1; i <= 15; i++) {
    const rowHTML = `
      <div class="row form-group align-items-center d-none showhide_row_${i.toString().padStart(2, '0')} addStoixSymb001"  id="row_${i.toString().padStart(2, '0')}">
        ...
        <button type="button" class="btn rounded-4 mt-2 col-0-3 clear-row" id="clearSelectSymbaseon-${i.toString().padStart(2, '0')} border-0" data-bs-toggle="tooltip" title="Καθαρισμός του πεδίου Στοιχείο Σύμβασης" data-bs-placement="bottom" data-target="stoixeio_symbashs_${i.toString().padStart(2, '0')}">
