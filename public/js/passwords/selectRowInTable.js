  ...
  rows.forEach(function (row) {
    row.addEventListener("click", function () {
      if (this.classList.contains("selected-row")) {
        ...
        if (selectedRowId) {
          document.getElementById("edit-btn").href = "/companies/passwords/edit/" + selectedRowId;
          document
            ...
            .addEventListener("click", async function (event) {
              ...
              var deleteUrl = "/companies/passwords/delete/" + selectedRowId;
              ...
              if (result.isConfirmed) {
                try {
                  ...
                  Swal.fire({
                    icon: "success",
                    title: "Επιτυχής Διαγραφή του Κωδικού Πρόσβασης",
                    timer: 2000,
