document.addEventListener("DOMContentLoaded", () => {
    ...
    async function handleFormSubmit(event) {
        ...
        try {
            ...
            if (isEmpty(formData.username))     errors.push("Username");
            if (isEmpty(formData.password))     errors.push("Password");
            ...
            const response = await fetch("/companies/passwords/add", {
                method: "POST",
                headers: {
            ...
            if (response.status === 204) {
                ...
                }).then(() => window.location.href = "/companies/passwords");
                return;
            }
            ...
            if (ct.includes("application/json")) {
                ...
                await Swal.fire({
                    ...
                    window.location.href = data.redirectUrl || "/companies/passwords";
                });
                return;
            }
