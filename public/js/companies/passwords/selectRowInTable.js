...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Βάσεις URLs
    const baseEdit   = "/companies/passwords/edit";
    const baseDelete = "/companies/passwords/delete"; 
        ...
        if (!btn) return;
            ...
            if (!selectedRowId) {
                ...
                await Swal.fire({
                    ...
                    title: "Καμία επιλογή",
                    html: `Παρακαλώ επιλέξτε πρώτα έναν κωδικό πρόσβασης από τον πίνακα.`,
                    icon: "info",
        ...
        btnDelete.addEventListener("click", async (e) => {
            ...
            try {
                ...
                if (resp.status === 204) {
                    ...
                    location.href = "/companies/passwords";
                    return;
                }
                ...
                if (ct.includes("application/json")) {
                    ...
                    location.href = data.redirectUrl || "/companies/passwords";
                    return;
                }
                ...
                await Swal.fire({
                    ...
                    willClose: () => {
                      window.location.href = "/companies/passwords"; // Ανακατεύθυνση μετά το κλείσιμο του SweetAlert
                    },
                });
            }
        });
