document.addEventListener("DOMContentLoaded", () => {
    ...
    async function handleFormSubmit(event) {
        ...
        try {
            ...
            const errors = [];
            if (isEmpty(formData.kodikos_dias_stathera))    errors.push("Τράπεζα");
            if (isEmpty(formData.logariasmos_1))            errors.push("IBAN 1ου Λογαριασμού");
            ...
            const response = await fetch("/companies/trapezes/add", {
                method: "POST",
                headers: {
            ...
            if (response.status === 204) {
                ...
                }).then(() => window.location.href = "/companies/trapezes");
                return;
            }
            ...
            if (ct.includes("application/json")) {
                ...
                await Swal.fire({
                    ...
                    window.location.href = data.redirectUrl || "/companies/trapezes";
                });
                return;
            }
