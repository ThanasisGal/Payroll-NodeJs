...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Βάσεις URLs
    const baseEdit   = "/companies/nomimoi_ekprosopoi/edit";
    const baseDelete = "/companies/nomimoi_ekprosopoi/delete"; 
        ...
        if (!btn) return;
            ...
            if (!selectedRowId) {
                ...
                await Swal.fire({
                    ...
                    title: "Καμία επιλογή",
                    html: `Παρακαλώ επιλέξτε πρώτα έναν εκπρόσωπο από τον πίνακα.`,
                    icon: "info",
        ...
        btnDelete.addEventListener("click", async (e) => {
            ...
            if (!selectedRowId) {
                await Swal.fire({
                    ...
                    allowOutsideClick: false,
                    title: "Καμία επιλογή",
                    html: `Παρακαλώ επιλέξτε πρώτα έναν Νόμιμο Εκπρόσωπο από τον πίνακα.`,
                    icon: "info",
                    showConfirmButton: true,
                    confirmButtonText: "Κλείσιμο",
                    backdrop: false,
            ...
            try {
                ...
                if (resp.status === 204) {
                    ...
                    location.href = "/companies/nomimoi_ekprosopoi";
                    return;
                }
                ...
                if (ct.includes("application/json")) {
                    ...
                    location.href = data.redirectUrl || "/companies/nomimoi_ekprosopoi";
                    return;
                }
