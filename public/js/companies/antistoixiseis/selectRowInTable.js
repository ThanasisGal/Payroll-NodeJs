document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("myTable").addEventListener("click", function (event) {
    ...
    if (!isSelected) {
      ...
      document.getElementById("add-btn").href = `/companies/antistoixiseis/add/${currentSelectedId}`;
  ...
  document.getElementById("delete-btn").addEventListener("click", async function (event) {
    ...
    const result = await Swal.fire({
      ...
      html: `ΠΡΟΣΟΧΗ!!! Θα διαγραφούν ΟΛΕΣ οι αντιστοιχίσεις Κ.Π.Κ. <mark>που αφορούν την κράτηση</mark> (<strong>για την συγκεκριμένη εταιρεία</strong>) και δεν θα μπορείτε να αναιρέσετε αυτή την ενέργεια!`,
      icon: "error",
