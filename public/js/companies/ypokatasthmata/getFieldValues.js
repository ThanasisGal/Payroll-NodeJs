document.addEventListener("DOMContentLoaded", () => {
    ...
    async function handleFormSubmit(event) {
        ...
        try {
            ...
            const response = await fetch("/companies/ypokatasthmata/add", {
                method: "POST",
                headers: {
            ...
            if (response.status === 204) {
                ...
                }).then(() => window.location.href = "/companies/ypokatasthmata");
                return;
            }
            ...
            if (ct.includes("application/json")) {
                ...
                await Swal.fire({
                    ...
                    window.location.href = data.redirectUrl || "/companies/ypokatasthmata";
                });
                return;
            }
