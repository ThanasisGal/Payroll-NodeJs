...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Βάσεις URLs
    const baseEdit   = "/companies/ypokatasthmata/edit";
    const baseDelete = "/companies/ypokatasthmata/delete"; 
        ...
        if (!btn) return;
            ...
            if (!selectedRowId) {
                ...
                await Swal.fire({
                    ...
                    title: "Καμία επιλογή",
                    html: `Παρακαλώ επιλέξτε πρώτα ένα υποκατάστημα από τον πίνακα.`,
                    icon: "info",
        ...
        btnDelete.addEventListener("click", async (e) => {
            ...
            try {
                ...
                if (resp.status === 204) {
                    ...
                    location.href = "/companies/ypokatasthmata";
                    return;
                }
                ...
                if (ct.includes("application/json")) {
                    ...
                    location.href = data.redirectUrl || "/companies/ypokatasthmata";
                    return;
                }
