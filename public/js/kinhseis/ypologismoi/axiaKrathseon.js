export async function ypologismosAxiasKrathseon(sharedParams) {
  ...
  // const asfalistikesApodoxesAllaghMikton = document.getElementById('asfalistikes_apodoxes_hidden_1');

  // // Αν λείπει κάποιο βασικό πεδίο, σταματάμε
  // if (!asfalistikesApodoxes) {
  //   console.error('ΔΕΝ ΒΡΕΘΗΚΕ το πεδίο asfalistikes_apodoxes!');
  //   return;
  // }
  // if (!asfalistikesApodoxesHidden) {
  //   console.error('ΔΕΝ ΒΡΕΘΗΚΕ το πεδίο asfalistikes_apodoxes_hidden!');
  //   return;
  // }
  // if (!synoloMiktonApodoxon) {
  //   console.error('ΔΕΝ ΒΡΕΘΗΚΕ το πεδίο synoloMiktonApodoxon!');
  //   return;
  // }

  // /***************************************************************
  //  * 2. Πεδία συνόλων κρατήσεων (αν χρειάζονται)
  //  ***************************************************************/
  ...
  //  ***************************************************************/
  // // 3.1 Μορφοποίηση αριθμών
  // function formatNumber(value, decimals = 2) {
  //   const num = parseFloat(value || '0');
  //   return num.toFixed(decimals).replace('.', ',');
  // }

  // // 3.2 getAnotatoOrio - Παράδειγμα
  ...
  // /***************************************************************
  //  * 4. Υπολογισμός Κρατήσεων
  //  ***************************************************************/
  // async function calculateValues() {
  //   console.log('Starting calculateValues');
  //   const totals = {
  //     ergazomenoy: 0,
  //     ergodoth: 0,
  ...
  //   for (let i = 1; i <= 7; i++) { // Αλλαγή από 7 σε 31
  ...
  //     ) {
  //       // console.warn(`Missing essential fields for idx=${idx}`);
  //       continue;
  //     }

  //     const value = document.getElementById(`asfalistikesApodoxes_${idx}`).value;
  //     const numericValue = parseFloat(value.replace(',', '.'));
  //     console.log(idx, numericValue);

  //     // Παίρνουμε τιμές
  //     const asfVal = parseFloat((fields.asfalistikesApodoxes.value || '0').replace(',', '.'));
  //     const anotatoOrio = getAnotatoOrio(idx);
  //     const adjustedVal = Math.min(asfVal, anotatoOrio);
  ...
  //     const axiaErgaz = adjustedVal * pErgaz + psErg;
  //     const axiaErgod = adjustedVal * pErgod + psErd;

  //     totals.ergazomenoy += axiaErgaz;
  //     totals.ergodoth += axiaErgod;

  //     if (fields.ypologizomenoStoForo.value === 'true') {
  ...
  //     // Ενημερώνουμε τις αξίες στα πεδία
  //     if (fields.axiaErgazomenoy) {
  //       fields.axiaErgazomenoy.value = formatNumber(axiaErgaz, 4);
  //     }
  //     if (fields.axiaErgodoth) {
  //       fields.axiaErgodoth.value = formatNumber(axiaErgod, 4);
  //     }

  //     // Αν δεν έχει οριστεί ακόμα η αρχική τιμή, αποθηκεύουμε την τρέχουσα τιμή ως αρχική
  //     if (!fields.asfalistikesApodoxes.dataset.initialValue) {
  //       fields.asfalistikesApodoxes.dataset.initialValue = asfVal;
  //     }
  //   }

  //   // Ενημέρωση συνόλων
  //   if (synoloAxiasFields.ergazomenoy) {
  //     synoloAxiasFields.ergazomenoy.value = formatNumber(totals.ergazomenoy, 2);
  //   }
  //   if (synoloAxiasFields.ergodoth) {
  //     synoloAxiasFields.ergodoth.value = formatNumber(totals.ergodoth, 2);
  //   }
  //   if (synoloAxiasFields.ergazomenoyYpologizomenhStoForo) {
  //     synoloAxiasFields.ergazomenoyYpologizomenhStoForo.value =
  //       formatNumber(totals.ergazomenoyYpologizomenhStoForo, 2);
  //   }
  //   if (synoloAxiasFields.ergazomenoyMhYpologizomenhStoForo) {
  //     synoloAxiasFields.ergazomenoyMhYpologizomenhStoForo.value =
  //       formatNumber(totals.ergazomenoyMhYpologizomenhStoForo, 2);
  //   }
  //   if (synoloAxiasFields.ergodothYpologizomenhStoForo) {
  //     synoloAxiasFields.ergodothYpologizomenhStoForo.value =
  //       formatNumber(totals.ergodothYpologizomenhStoForo, 2);
  //   }
  //   if (synoloAxiasFields.ergodothMhYpologizomenhStoForo) {
  //     synoloAxiasFields.ergodothMhYpologizomenhStoForo.value =
  //       formatNumber(totals.ergodothMhYpologizomenhStoForo, 2);
  //   }

  //   if (synoloAxiasFields.krathseon) {
  //     synoloAxiasFields.krathseon.value = formatNumber(totals.ergazomenoy, 2);
  //   }

  //   // Καλούμε, αν θέλουμε, και πληρωτέο
  ...
  // /***************************************************************
  //  * 5. Συνάρτηση: updateAsfalistikesApodoxesXX
  //  ***************************************************************/
  // function updateAsfalistikesApodoxesXX(newValue) {
  //   console.log(`Updating asfalistikesApodoxes_XX with newValue=${newValue}`);
  //   for (let i = 1; i <= 7; i++) { // Loop over 31 fields
  //     const idx = i.toString().padStart(2, '0');
  //     const field = document.getElementById(`asfalistikesApodoxes_${idx}`);
  //     if (!field) {
  //       // console.warn(`Field asfalistikesApodoxes_${idx} not found.`);
  //       continue;
  //     }

  //     const initialVal = parseFloat(field.dataset.initialValue || '0');
  //     console.log(initialVal)
  //     const fieldVal = parseFloat(field.value.replace(',', '.') || '0');

  //     const tolerance = 0.0001;
  //     if (Math.abs(fieldVal - initialVal) < tolerance) {
  //       const anotato = getAnotatoOrio(idx);
  //       const updatedVal = Math.min(newValue, anotato);
  //       field.value = formatNumber(updatedVal, 2);
  //     }
  //   }
  // }

  // /***************************************************************
  //  * 6. Συνάρτηση: handleSynoloMiktonChange
  //  ***************************************************************/
  // async function handleSynoloMiktonChange() {
  //   console.log('handleSynoloMiktonChange called');
  //   let newVal = parseFloat((synoloMiktonApodoxon.value || '0').replace(',', '.'));
  //   if (isNaN(newVal)) {
  //     newVal = 0;
  //   }
  //   // Update asfalistikesApodoxes value
  //   asfalistikesApodoxes.value = formatNumber(newVal, 2);

  //   // Update asfalistikesApodoxes_XX fields based on their own initial values
  ...
  // /***************************************************************
  //  * 7. Συνάρτηση: handleAsfalistikesApodoxesChange
  //  ***************************************************************/
  ...
  // // Κάνουμε τις συναρτήσεις global
  ...
  // /***************************************************************
  //  * 4. Αρχική Φόρτωση: Κάνουμε έναν πρώτο υπολογισμό και ορίζουμε τις αρχικές τιμές
  //  ***************************************************************/
  // console.log('Starting initial calculation');
  // await calculateValues();
  // console.log('Initial calculation done');

  // // Μετά τον αρχικό υπολογισμό, ορίζουμε το initialValue βασισμένο στο synoloMiktonApodoxon
  // const initialTotal = parseFloat((synoloMiktonApodoxon.value || '0').replace(',', '.') || '0');

  // // Συγχρονίζουμε το hidden πεδίο με το τρέχον asfalistikesApodoxes
  // asfalistikesApodoxesHidden.value = asfalistikesApodoxes.value;
  // asfalistikesApodoxesAllaghMikton.value = asfalistikesApodoxes.value;
