...
const typedFields = { repo_apologistika: 'Boolean', adeia_apologistika: 'Boolean', ores_apoysias_apologistika: 'Number', ores_ergasias_apologistika: 'Number', ores_pragmatikhs_ergasias_apologistika: 'Number', ores_adeias_pistomenes_apologistika: 'Number', ores_argias_pistomenes_apologistika: 'Number', kathgoria_ergasias_apologistika: 'String', kathgoria_adeias_apologistika: 'String', apo_ora_01_apologistika: 'String', eos_ora_01_apologistika: 'String', apo_ora_02_apologistika: 'String', eos_ora_02_apologistika: 'String', apo_ora_03_apologistika: 'String', eos_ora_03_apologistika: 'String' };
...
for (const schema of [valuesSchema, afterValuesSchema]) assert.strictEqual(schema.path('compensation_breakdown_apologistika').instance, 'Embedded');
