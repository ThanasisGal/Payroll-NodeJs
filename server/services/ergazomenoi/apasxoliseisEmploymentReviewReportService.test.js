...
test('η 7η ημέρα προέρχεται μόνο από το τελικό εβδομαδιαίο αποτέλεσμα', () => {
    ...
    assert.equal(report.daily[0].seventhDay, false);
    assert.equal(report.weekly[0].seventhDay, '');
