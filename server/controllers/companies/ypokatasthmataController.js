...
import formatNumber from "../../../public/utils/formatNumber.js";
...
class ypokatasthmataController {
  static mainYpokatasthmataForm = async (req, res) => {
    ...
    try {
      ...
      const countResults = await YpokatasthmataModel.aggregate(
        countPipeline
      ).exec();
      ...
      const ypokatasthmata = await YpokatasthmataModel.aggregate(
        queryPipeline
      ).exec();
