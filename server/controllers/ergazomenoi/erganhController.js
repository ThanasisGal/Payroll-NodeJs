...
class erganhController {
    ...
    static eisagoghOrarionApoErganh = async (req, res) => {
        ...
        async function processWorkHours(username, password, fromDate, toDate, afm, pararthma) {
            ...
            let excelFilePath;
            try {
                excelFilePath = await downloadOrariaExcel(
                    username,
                    password,
                    fromDate,
                    toDate,
                ...
                if (excelFilePath) {
                    try {
                        ...
                        res.json({
                            success: true,
                            redirectUrl: '/ergazomenoi/programmata/eisagoghOrarionApoErganh'
                        });
                    } catch (unlinkError) {
        ...
        async function downloadOrariaExcel(username, password, fromDate, toDate, afm, pararthma) {
            ...
            try {
                ...
                await page.click(
                    'xpath=//*[@id="ctl00_ctl00_ContentHolder_ContentHolder_SdcTableMenu"]/div/ol/li[2]/ol/li[3]/ol/li[4]/div/a'
                );
                ...
                if (afm) {
                    await page.fill(
                        '#ctl00_ctl00_ContentHolder_ContentHolder_ErgazomenosWorkingSearchControl_AfmEdit',
                        afm
                    );
                }
                ...
                await page.click(
                    'xpath=//*[@id="igtxtctl00_ctl00_ContentHolder_ContentHolder_ErgazomenosWorkingSearchControl_DateFromEdit"]'
                );
                await page.fill(
                    'xpath=//*[@id="igtxtctl00_ctl00_ContentHolder_ContentHolder_ErgazomenosWorkingSearchControl_DateFromEdit"]',
                    fromDateStr
                ...
                await page.click(
                    'xpath=//*[@id="igtxtctl00_ctl00_ContentHolder_ContentHolder_ErgazomenosWorkingSearchControl_DateToEdit"]'
                );
                await page.fill(
                    'xpath=//*[@id="igtxtctl00_ctl00_ContentHolder_ContentHolder_ErgazomenosWorkingSearchControl_DateToEdit"]',
                    toDateStr
        ...
        function groupByAFM(xlsData) {
            const grouped = {};
            for (const row of xlsData.slice(1)) {
                // Παραλείπουμε την πρώτη γραμμή (επικεφαλίδα)
                const afm = row[1];
                if (!grouped[afm]) {
                    grouped[afm] = [];
                }
            ...
            for (const afm in employeeData) {
                ...
                allDays.forEach((hmeromhniaErgasias) => {
                    ...
                    if (existingRow) {
                        ...
                        orariaData.ores_nominhs_yperorias_argion_nyxtas =
                        ...
                        orariaData.ores_paranomhs_yperorias_argion =
                            workHours.holidayOvertimeIllegal;
                        orariaData.ores_paranomhs_yperorias_argion_nyxtas =
                        ...
                        orariaData_oraria.ores_yperergasias_argion_oraria =
                            workHours.holidayOverwork;
                        orariaData_oraria.ores_yperergasias_argion_nyxtas_oraria =
                            workHours.nightHolidayOverwork;
                        orariaData_oraria.ores_nominhs_yperorias_oraria = workHours.overtime;
                        orariaData_oraria.ores_nominhs_yperorias_nyxtas_oraria =
                            workHours.nightOvertime;
                        orariaData_oraria.ores_nominhs_yperorias_argion_oraria =
                            workHours.holidayOvertime;
                        orariaData_oraria.ores_nominhs_yperorias_argion_nyxtas_oraria =
                            workHours.nightHolidayOvertime;
                        orariaData_oraria.ores_paranomhs_yperorias_oraria =
                            workHours.overtimeIllegal;
                        orariaData_oraria.ores_paranomhs_yperorias_nyxtas_oraria =
                            workHours.nightOvertimeIllegal;
                        orariaData_oraria.ores_paranomhs_yperorias_argion_oraria =
                            workHours.holidayOvertimeIllegal;
                        orariaData_oraria.ores_paranomhs_yperorias_argion_nyxtas_oraria =
                            workHours.nightHolidayOvertimeIllegal;
                ...
                for (let i = 0; i < intervals.length; i++) {
                    ...
                    if (weeklyTotal <= 40) {
                        ...
                        for (let j = fromDay; j <= toDay; j++) {
                            ...
                            let ores_ergasias_oraria =
                                (operations_oraria[j].updateOne.update.$set.ores_ergasias || 0) +
                                (operations_oraria[j].updateOne.update.$set.ores_yperergasias ||
                                    0) +
                                (operations_oraria[j].updateOne.update.$set
                                    .ores_yperergasias_nyxtas || 0) +
                                (operations_oraria[j].updateOne.update.$set
                                    .ores_yperergasias_argion || 0) +
                                (operations_oraria[j].updateOne.update.$set
                            ...
                            let ores_nyxtas_oraria =
                                (operations_oraria[j].updateOne.update.$set.ores_nyxtas || 0) +
                                (operations_oraria[j].updateOne.update.$set
                                    .ores_yperergasias_nyxtas || 0) +
                                (operations_oraria[j].updateOne.update.$set
                                    .ores_yperergasias_argion_nyxtas || 0);

                            let ores_argion_oraria =
                                (operations_oraria[j].updateOne.update.$set.ores_argion || 0) +
                                (operations_oraria[j].updateOne.update.$set
                                    .ores_yperergasias_argion || 0) +
                                (operations_oraria[j].updateOne.update.$set
                                    .ores_yperergasias_argion_nyxtas || 0);

                            operations_oraria[j].updateOne.update.$set.ores_ergasias_oraria =
                                ores_ergasias;
                            operations_oraria[j].updateOne.update.$set.ores_nyxtas_oraria =
                                ores_nyxtas;
                            operations_oraria[j].updateOne.update.$set.ores_argion_oraria =
                                ores_argion;
                            operations_oraria[j].updateOne.update.$set.ores_yperergasias_oraria = 0;
                            operations_oraria[
                                j
                            ].updateOne.update.$set.ores_yperergasias_nyxtas_oraria = 0;
                            operations_oraria[
                                j
                            ].updateOne.update.$set.ores_yperergasias_argion_oraria = 0;
                            operations_oraria[
                                j
                            ].updateOne.update.$set.ores_yperergasias_argion_nyxtas_oraria = 0;
                        }
                    }
                }
...
async function saveTelikoToMongo(sheetTeliko, sessionTeam) {
    ...
    if (bulkOps.length > 0) {
        ...
        // console.log(
        //     `[saveTelikoToMongo] ✅ bulkWrite: ${result.upsertedCount} inserted, ${result.modifiedCount} updated`
        // );
    }

    // console.log('[saveTelikoToMongo] ✅ Ολοκληρώθηκε η αποθήκευση στη MongoDB');
}
