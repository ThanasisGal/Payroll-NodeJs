...
assert.match(stage1Read, /buildWeeklyHrPayloadFromLoadedContext/);
assert.match(controller, /authoritative_stage1_payload: authoritativeStage1Payload/);
assert.match(controller, /state: \{ stage1: completion\.stage1 \}/);
assert.match(controller, /includeAuthoritativePayload: true/);
assert.match(controller, /function buildWeeklyHrDailyPresentation/);
assert.match(controller, /resolveStage3DailyActualWorkFacts\(row\)/);
assert.match(controller, /declared_intervals/);
assert.match(controller, /card_intervals/);
assert.match(controller, /current_apologistiko_classification/);
