const USER_PRIVILEGE_FORM_CATALOG_SEED = Object.freeze([
    ...
    { form: 'LhpshOrarionApoErganh', formLabel: 'ΜΗ Δανειζόμενων Εργαζόμενων', sidebarOrder: 9000, active: true, showInPrivileges: true },
    { form: 'LhpshProdhlomenonOrarionMonoDaneizomenon', formLabel: 'ΜΟΝΟ Δανειζόμενων Εργαζόμενων', sidebarOrder: 9500, active: true, showInPrivileges: true },
    { form: 'LhpshOrarionApoKartes', formLabel: 'ΜΗ Δανειζόμενων Εργαζόμενων', sidebarOrder: 10000, active: true, showInPrivileges: true },
    { form: 'LhpshPshfiakonKartonMonoDaneizomenon', formLabel: 'ΜΟΝΟ Δανειζόμενων Εργαζόμενων', sidebarOrder: 10500, active: true, showInPrivileges: true },
    ...
    { form: 'EidikothtesSymbaseon', formLabel: 'Ειδικότητες Συμβάσεων', sidebarOrder: 18000, active: true, showInPrivileges: true },
    { form: 'StoixeiaSymbaseon', formLabel: 'Στοιχεία Συμβάσεων', sidebarOrder: 19000, active: true, showInPrivileges: true },
    { form: 'KlimakiaSymbaseon', formLabel: 'Κλιμάκια Συμβάσεων', sidebarOrder: 20000, active: true, showInPrivileges: true },
    { form: 'YpologismoiKlimakionSymbaseon', formLabel: 'Υπολογισμός Κλιμακίων Συμβάσεων', sidebarOrder: 21000, active: true, showInPrivileges: true },
    { form: 'Apasxolhseis', formLabel: 'Απασχολήσεις', sidebarOrder: 22000, active: true, showInPrivileges: true },
    { form: 'EktyposhAtomikonEkkathariseon', formLabel: 'Αποδείξεις Μισθοδοσίας', sidebarOrder: 23000, active: true, showInPrivileges: true },
    { form: 'EktyposhSymbaseonErgazomenon', formLabel: 'Εργαζόμενων', sidebarOrder: 24000, active: true, showInPrivileges: true },
