const USER_PRIVILEGE_FORM_CATALOG_SEED = Object.freeze([
    ...
    { form: 'CalcApasxolhseisDaneizomenoyProsopikoy', formLabel: 'Υπολογισμός Απασχολήσεων Δανειζόμενου Προσωπικού', sidebarOrder: 12000, active: true, showInPrivileges: true },
