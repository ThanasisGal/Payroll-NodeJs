...
const ErgazomenoiSchema = new Schema(
    {
        ...
        afm_daneizontos_ergodoth: { type: String, default: '', trim: true },
        afm_daneizomenoy_ergodoth: { type: String, default: '', trim: true },
        typos_ergodoth_daneismoy: { type: Boolean, default: false },
        kodikos_ergazomenoy_alloy_ergodoth: { type: String, default: '', trim: true },
