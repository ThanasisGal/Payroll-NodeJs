...
async function generateContractPDF(ergazomenos, userContext) {
    try {
        ...
        const data = {
            ...
            _ETAIREIA: company.firstname == "" ? "εταιρία" : "επιχείρηση",
            _ERGODOTHS: company.firstname == "" ? "η εταιρία" : "η εργοδότρια",
            _ERGODOTHS_XORIS_ARTHRO: company.firstname == "" ? "εταιρία" : "εργοδότρια",
            _ERGODOTHS_CAPITAL_A: company.firstname == "" ? "Η εταιρία" : "Η εργοδότρια",
            _ERGODOTHS_GENIKH: company.firstname == "" ? "της εταιρίας" : "της εργοδότριας",
            _ERGODOTHS_AITIATIKH: company.firstname == "" ? "την εταιρία" : "την εργοδότρια",
