...
console.log('📋 [adminRoutes] Registering GET /aws_s3'); // ✅ ADD THIS

// ============================================================================
// GET /admin/aws_s3 - Render Upload Page
// ============================================================================
router.get('/aws_s3', requireAdmin, async (req, res) => {
    console.log('🌐 GET /api/admin/aws_s3 hit'); // ✅ ADD THIS
...
console.log('📋 [adminRoutes] Registering POST /templates/upload'); // ✅ ADD THIS
...
console.log('✅ [adminRoutes] Module loaded successfully'); // ✅ ADD THIS
