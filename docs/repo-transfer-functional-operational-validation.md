...
- Όταν ο υπολογισμός εκτελείται για συγκεκριμένο παράρτημα, τόσο η κύρια
  ανάγνωση των ημερήσιων εγγραφών όσο και ο εβδομαδιαίος post-check
  περιορίζονται στο ίδιο παράρτημα. Η αντικατάσταση των αποθηκευμένων
  αποκλίσεων περιορίζεται επίσης στο επιλεγμένο παράρτημα· εγγραφές και
  αποκλίσεις άλλων παραρτημάτων της εταιρείας δεν διαβάζονται ή διαγράφονται.
